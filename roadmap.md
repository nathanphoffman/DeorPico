...
- Working ctrl + del change, error change, and navigate prevention
- Working: Add markdown highlighting for .md files if it is not provided by our highlighting library
